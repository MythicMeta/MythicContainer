...
func SendMythicRPCOperationEventLogCreate(ctx context.Context, input MythicRPCOperationEventLogCreateMessage) (*MythicRPCOperationEventLogCreateMessageResponse, error) {
