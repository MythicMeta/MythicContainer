...
func SendMythicRPCPayloadCreateFromScratch(ctx context.Context, input MythicRPCPayloadCreateFromScratchMessage) (*MythicRPCPayloadCreateFromScratchMessageResponse, error) {
