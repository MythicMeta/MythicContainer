...
func SendMythicRPCPayloadCreateFromUuid(ctx context.Context, input MythicRPCPayloadCreateFromUUIDMessage) (*MythicRPCPayloadCreateFromUUIDMessageResponse, error) {
