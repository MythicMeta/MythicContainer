...
func SendMythicRPCTaskDisplayToRealIdSearch(ctx context.Context, input MythicRPCTaskDisplayToRealIdSearchMessage) (*MythicRPCTaskDisplayToRealIdSearchMessageResponse, error) {
